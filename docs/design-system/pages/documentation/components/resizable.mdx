...
import { ResizablePreview, ResizableVertical, ResizableWithHandle } from '@docs/components/components-resizable.tsx'
...
<Cards className='mt-8'>
  <Card
    title="🤖 Storybook"
    href="https://www.stories.fusillo.aldente.design/?path=/docs/components-resizable--documentation"
  />
  <Card
    title="🪄 Figma"
