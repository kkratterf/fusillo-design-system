...
import { TagPreview, TagRed, TagOrange, TagAmber, TagYellow, TagLime, TagGreen, TagEmerald, TagTeal, TagCyan, TagSky, TagBlue, TagIndigo, TagViolet, TagPurple, TagFuchsia, TagPink, TagRose } from '@docs/components/preview/tag.tsx'
