...
For guidance on crafting meaningful text, refer to our [accessibility guidelines](/documentation/foundations/accessibility).
...
Here you can find the [Icon Gallery](/documentation/components/icon#icon-gallery) with list of all available icons.
