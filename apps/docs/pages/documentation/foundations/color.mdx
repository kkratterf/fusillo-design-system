import {
  FoundationsColor,
  ColorRoles,
} from '@docs/components/foundations-color.mdx';

export const colorRolesData = [
  { name: 'Brand', token: 'brand-[]', previewClass: '--bg-brand' },
  { name: 'Neutral', token: 'neutral-[]', previewClass: '--bg-inverse' },
  { name: 'Danger', token: 'red-[]', previewClass: '--bg-danger' },
  { name: 'Warning', token: 'amber-[]', previewClass: '--bg-warning' },
];
