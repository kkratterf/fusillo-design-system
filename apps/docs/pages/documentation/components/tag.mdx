...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```js copy {6} /status="default"/ filename="tag.tsx"
    import { Tag } from "@/components/tag";
    import { Umbrella } from 'lucide-react';
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```js copy {6} /status="brand"/ filename="tag.tsx"
    import { Tag } from "@/components/tag";
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```js copy {6} /status="danger"/ filename="tag.tsx"
    import { Tag } from "@/components/tag";
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```js copy {6} /status="warning"/ filename="tag.tsx"
    import { Tag } from "@/components/tag";
