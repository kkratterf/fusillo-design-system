...
import { collapsibleAccessibilityData } from '@docs/components/accessibility/collapsible.mdx';
import { CollapsiblePreview } from '@docs/components/components-collapsible.tsx'
