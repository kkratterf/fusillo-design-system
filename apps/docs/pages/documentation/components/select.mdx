...
import { selectAccessibilityData } from '@docs/components/accessibility/select.mdx';
import {
  SelectPreview, SelectScrollable, SelectWithForm
} from '@docs/components/components-select.tsx';
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://main--653e613f4feb85c1b6467ba7.chromatic.com/?path=/docs/components-select--documentation"
  />
  <Card
    title="🪄 Figma"
...
Use our [Label](https://fusillo-design-system.vercel.app/documentation/components/label) component in order to offer a visual and accessible label for the select.
