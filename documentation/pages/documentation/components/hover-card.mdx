...
import { HoverCardPreview } from '@/docs/components/components-hover-card.tsx'
                ...
                <HoverCardContent>
                    <div>
                        ...
                        <div>
                            ...
                            <div><span>Joined December 2021</span></div>
                        </div>
                    </div>
                </HoverCardContent>
            </HoverCard>
...
<Cards className='mt-8'>
  <Card
    title="🤖 Storybook"
    href="https://main--653e613f4feb85c1b6467ba7.chromatic.com/?path=/docs/components-hovercard--documentation"
  />
  <Card
    title="🪄 Figma"
