...
import { TagPreview, TagDefault, TagBrand, TagDanger, TagWarning, TagSuccess, TagInfo, TagDiscovery  } from '@/docs/components/components-tag.tsx'
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    export function TagDemo() {
        return (
            <Tag status="discovery">
                <BrainCircuit /> New feature
            </Tag>
        );
    }
    ```
