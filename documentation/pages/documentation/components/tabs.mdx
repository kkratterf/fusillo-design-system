...
import { tabsAccessibilityData } from '@/docs/components/accessibility/tabs.mdx';
import { TabsPreview, TabsDefault, TabsDefaultValue, TabsDisabled, TabsWithIcon, TabsWithCard } from '@/docs/components/components-tabs.tsx'
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```js copy {5} /defaultValue="password"/
    import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/tabs"
