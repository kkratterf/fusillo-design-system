...
import { menubarAccessibilityData } from '@/docs/components/accessibility/menubar.mdx';
import { MenubarPreview } from '@/docs/components/components-menubar.tsx';
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://main--653e613f4feb85c1b6467ba7.chromatic.com/?path=/docs/components-menubar--documentation"
  />
  <Card
    title="🪄 Figma"
