...
import { SkeletonPreview, SkeletonCircle, SkeletonLine, SkeletonCard  } from '@/docs/components/components-skeleton.tsx'
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```js copy {2,6,7,13,14} /Card/ /CardContent/
    import { Skeleton } from "@/components/skeleton"
...
<Cards className='mt-8'>
  <Card
    title="🤖 Storybook"
    href="https://main--653e613f4feb85c1b6467ba7.chromatic.com/?path=/docs/components-skeleton--documentation"
  />
  <Card
    title="🪄 Figma"
