...
import { ScrollAreaPreview, ScrollAreaHorizontal } from '@/docs/components/components-scroll-area.tsx'
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```js copy {46} /orientation="horizontal"/
    import * as React from "react"
...
<Cards className='mt-8'>
  <Card
    title="🤖 Storybook"
    href="https://main--653e613f4feb85c1b6467ba7.chromatic.com/?path=/docs/components-scrollarea--documentation"
  />
  <Card
    title="🪄 Figma"
