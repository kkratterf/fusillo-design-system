...
<br />
{
  <table className="w-full">
    ...
    <tbody className="w-full">
      <tr className="w-full bg-transparent dark:bg-transparent even:bg-transparent even:dark:bg-transparent border-0">
        <td className="w-full order-t-0 border-x-0 p-2">
          <div className="font-medium">
            <code>color-border-primary</code>
          </div>
        </td>
        <td className="order-t-0 border-x-0 p-2">
          <div className="w-28 font-medium opacity-70">
            <code>
              {tokens.Tokens.Light.Color.Border.Neutral['border-primary'].type}
            </code>
          </div>
        </td>
        <td className="order-t-0 border-x-0 p-2">
          <div className="w-28 font-medium opacity-70">
            <code>
              {tokens.Tokens.Light.Color.Border.Neutral['border-primary'].value}
            </code>
          </div>
        </td>
        <td className="order-t-0 border-x-0 p-2">
          <div className="w-28 font-medium opacity-70">
            <code>
              {tokens.Tokens.Dark.Color.Border.Neutral['border-primary'].value}
            </code>
          </div>
        </td>
      </tr>
      ...
      <tr className="w-full bg-transparent dark:bg-transparent even:bg-transparent even:dark:bg-transparent border-0">
        <td className="w-full order-t-0 border-x-0 p-2">
          <div className="font-medium">
            <code>color-bg-interactive</code>
          </div>
        </td>
        <td className="order-t-0 border-x-0 p-2">
          <div className="w-28 font-medium opacity-70">
      ...
      <tr className="w-full bg-transparent dark:bg-transparent even:bg-transparent even:dark:bg-transparent border-0">
        <td className="w-full order-t-0 border-x-0 p-2">
          <div className="font-medium">
            <code>color-bg-interactive-hover</code>
          </div>
        </td>
        <td className="order-t-0 border-x-0 p-2">
          <div className="w-28 font-medium opacity-70">
      ...
      <tr className="w-full bg-transparent dark:bg-transparent even:bg-transparent even:dark:bg-transparent border-0">
        <td className="w-full order-t-0 border-x-0 p-2">
          <div className="font-medium">
            <code>color-bg-container-subtle</code>
          </div>
        </td>
        <td className="order-t-0 border-x-0 p-2">
          <div className="w-28 font-medium opacity-70">
