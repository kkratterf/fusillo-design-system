...
import { accordionAccessibilityData } from '@/docs/components/accessibility/accordion.mdx';
import {
  AccordionPreview,
  AccordionSingle,
  AccordionMultiple,
...
} from '@/docs/components/components-accordion.tsx';
