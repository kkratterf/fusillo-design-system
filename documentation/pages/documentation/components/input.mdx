...
import { InputPreview, InputDefault, InputFile, InputDisabled, InputWithLabel, InputWithButton, InputWithForm } from '@/docs/components/components-input.tsx'
...
<Cards className='mt-8'>
  <Card
    title="🤖 Storybook"
    href="https://main--653e613f4feb85c1b6467ba7.chromatic.com/?path=/docs/components-input--documentation"
  />
  <Card
    title="🪄 Figma"
