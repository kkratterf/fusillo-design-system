...
import { AlertPreview, AlertDefault, AlertDanger, AlertWarning, AlertSuccess, AlertInfo, AlertDiscovery } from '@/docs/components/components-alert.tsx'
