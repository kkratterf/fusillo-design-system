...
import { dialogAccessibilityData } from '@/docs/components/accessibility/dialog.mdx';
import { DialogPreview, DialogCustomClose } from '@/docs/components/components-dialog.tsx'
