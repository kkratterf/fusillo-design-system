...
import { CollapsiblePreview, CollapsibleAccessibility } from '@/docs/components/components-collapsible.tsx'
  ...
  <Tabs.Tab>
    ...
    export const CollapsibleDemo = () => {
        ...
        return (
            ...
            >
                <div>
                    <p>@kkratter starred 3 repositories</p>
                ...
                <div>@design-system/foundations</div>
                <CollapsibleContent>
                    <div>@design-system/tokens</div>
                    <div>@design-system/components</div>
                    <div>@design-system/data-visualization</div>
                </CollapsibleContent>
            </Collapsible>
        );
    };
...
<Cards className='mt-8'>
  <Card
    title="🤖 Storybook"
    href="https://main--653e613f4feb85c1b6467ba7.chromatic.com/?path=/docs/components-collapsible--documentation"
  />
  <Card
    title="🪄 Figma"
