  ...
  const accordionAccessibilityData = [
    ...
    },
    {
      ...
      (
        <>
          When focus is on an{' '}
          <code className="cell-accessibility-code">AccordionTrigger</code>, moves focus to the first{' '}
          <code className="cell-accessibility-code">AccordionTrigger</code>
        </>
      ),
    },
    {
      ...
      (
        <>
          When focus is on an{' '}
          <code className="cell-accessibility-code">AccordionTrigger</code>, moves focus to the last{' '}
          <code className="cell-accessibility-code">AccordionTrigger</code>
        </>
      ),
    },
